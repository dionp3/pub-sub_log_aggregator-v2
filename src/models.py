...
class EventPayload(BaseModel):
    """
    Struktur data payload event, dapat berisi data dinamis.
    """
...
class Event(BaseModel):
    """
    T4 & API: Skema Event yang diterima melalui endpoint /publish.
    """
...
class ProcessedEvent(BaseModel):
    """
    Skema respons untuk event yang sudah berhasil diproses dan disimpan (GET /events).
    """
    event_id: str
    topic: str
...
class AggregatorStats(BaseModel):
    """
    Skema respons untuk metrik operasional (GET /stats).
    """
